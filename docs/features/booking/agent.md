# AI Coding Instructions: ระบบจองห้องประชุมและยานพาหนะ (Resource Reservation & Conflict Detection)

## 1. กฎเหล็กและข้อห้าม (Hard Rules)
- **ห้ามแก้ไขไฟล์นอกโมดูล:** แก้ไขเฉพาะภายใน `src/features/booking/` หรือโฟลเดอร์ที่เกี่ยวข้องโดยตรง
- **ความปลอดภัยของสิทธิ์:** ใช้ `requirePermission(session, "booking:read")` เสมอ
