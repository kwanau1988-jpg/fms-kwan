# AI Coding Instructions: ระบบจัดการบุคลากร (Faculty Personnel & Directory Management)

## 1. กฎเหล็กและข้อห้าม (Hard Rules)
- **ห้ามแก้ไขไฟล์นอกโมดูล:** แก้ไขเฉพาะภายใน `src/features/personnel/` หรือโฟลเดอร์ที่เกี่ยวข้องโดยตรง
- **ความปลอดภัยของสิทธิ์:** ใช้ `requirePermission(session, "personnel:read")` เสมอ
