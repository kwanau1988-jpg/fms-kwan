# PRD: ระบบจัดการบุคลากร (Faculty Personnel & Directory Management)

## 1. วัตถุประสงค์ (Objective)
ระบบทำเนียบคณาจารย์และเจ้าหน้าที่คณะ แสดงประวัติ ตำแหน่งวิชาการ ภาควิชา ข้อมูลติดต่อ และการจัดเรียงลำดับการแสดงผล ออกแบบตามมาตรฐาน Modular Monolith และสอดคล้องกับระเบียบราชการของสถาบันอุดมศึกษา
