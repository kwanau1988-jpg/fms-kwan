# PRD: ระบบจัดการหลักสูตรการศึกษา (Academic Curriculum & MKO 2 Management)

## 1. วัตถุประสงค์ (Objective)
ระบบบริหารจัดการหลักสูตรการศึกษาตามมาตรฐาน มคอ. 2 (TQF 2) รองรับโครงสร้างหมวดวิชา ผลลัพธ์การเรียนรู้ (PLOs) อาชีพที่รองรับ และการ Import/Export ข้อมูลเป็นไฟล์ JSON ออกแบบตามมาตรฐาน Modular Monolith และสอดคล้องกับระเบียบราชการของสถาบันอุดมศึกษา
