# AI Coding Instructions: ระบบบริหารจัดการและอนุมัติเอกสาร (E-Document Approval Workflow)

## 1. กฎเหล็กและข้อห้าม (Hard Rules)
- **ห้ามแก้ไขไฟล์นอกโมดูล:** แก้ไขเฉพาะภายใน `src/features/documents/` หรือโฟลเดอร์ที่เกี่ยวข้องโดยตรง
- **ความปลอดภัยของสิทธิ์:** ใช้ `requirePermission(session, "documents:read")` เสมอ
